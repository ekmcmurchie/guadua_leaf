...
```{r}
reveal.model.designs(model3.rrpp) # This step appears not to be working properly

null <- lm.rrpp(guadua_y_dist_matrix ~ region)

PW <- pairwise(model3.rrpp,fit.null = null,groups = region)
