...
floret <- floret %>%
  mutate(across(c(specimen, species, country, region,habitat, general_habitat, 
                  savanna_presence, habit, recorder, lemma_papillae, lemma_prickle,
                  lemma_bicellular, lemma_macro, lemma_rondel, lemma_cross, lemma_bilobate_vertical,
                  ...
                  palea_papillae, palea_margin_prickle, palea_margin_bicellular, palea_margin_macro,
...
floret <- floret %>%
  mutate(across(c(specimen, species, country, region,habitat, general_habitat, 
                  savanna_presence, habit, recorder), tolower))
```
...
(floret <- floret %>% # this step reorders columns so binary data are placed last
    select(specimen, species, country, region,habitat, general_habitat, 
                  savanna_presence, habit, general_habit, recorder, everything()))
```
