...
For this PCoA, individual specimens are colored by the habit typical of their species. Three habitat groups were used: big and erect, leaning/climbing, and small arching. This PCoA is used as Figure 4 in the manuscript.
```{r}
...
For this PCoA, individual specimens are colored by species. This PCoA is used as Appendix Figure 5 in the manuscript.

```{r}

group.colors <- c("g_aculeata" = "#7b3294", "g_amplexifolia" = "#1b7837",
                  "g_angustifolia" = "#f1a340", "g_calderoniana" = "#9970ab","g_chacoensis" = "#5aae61",
                  "g_chaparensis" = "#7f3b08", "g_ciliata" = "#40004b", "g_glomerata" = "#00441b", 
                  ...
                  "g_aff_paraguayana" = "#662506", "g_aff_sarcocarpa" = "#993404", "g_aff_trinii" = "#41ab5d",
                  "g_aff_virgata" = "#ae017e", "g_aff_weberbaueri" = "#d4b9da") #to set colors
...
speciespcoa <- nice_df %>% 
  ...
  scale_color_manual(name = "Species", 
                     breaks = c("g_aculeata", "g_amplexifolia","g_angustifolia",
                                ...
                                "g_virgata", "g_weberbaueri", "g_aff_paraguayana", "g_aff_sarcocarpa",
                                ...
                                labels = c("G. aculeata", "G. amplexifolia", "G. angustifolia",
                                           ...
                                           "G. aff. paraguayana", "G. aff. sarcocarpa", "G. aff. trinii",
    ...
    scale_shape_manual(name = "Species", 
                     ...
                     values = c(15, 17, 19, 18, 3, 8, 4, 7, 9, 15, 3, 25, 23, 24, 21, 22, 18, 7, 9, 8, 
                                15, 17, 19, 18, 15, 17, 8, 23, 24, 21, 22, 8, 3)) + 
  theme_minimal() +
  theme(
    panel.border = element_rect(size = 2, color = "black", fill = NA)
  ) + 
...
For this PCoA, individual specimens are colored by the habit typical of their species. Two habitat groups were used: big and erect or leaning/climbing and small arching. This PCoA was not used in the manuscript; it was simply used to visualize the broader categories used for data analysis.
```{r}
...
For this PCoA, individual specimens are colored by the habitat typical of their species. Three habitat groups were used: Forest, river, and savanna. This PCoA is used as Figure 3 in the manuscript.
```{r}
...
For this PCoA, individual specimens are colored by the habitat typical of their species. Two habitat groups were used: Forest or river and savanna. This PCoA was not used in the manuscript; it was simply used to visualize the broader categories later used for data analysis.
```{r}
...
## Pie charts - specimens from forest and riparian species

##Filtering dataframe for forest and riparian species only
```{r}
#Filter dataframe of foliar micromorphology to include only forest and riparian species
guadualeaf_general_forest <- df_guadualeaf %>%
  filter(general_habitat == "general_forest")
```

##General forest: Pie chart of simple papillae on long cells of stomatal regions on abaxial leaf surface presence/absence
```{r}
#Group by simple papillae on long cells of stomatal regions on abaxial surface only and obtain percentage present/absent
guadualeaf_general_forest_per_ab_pap_sto <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_per_ab_pap_sto)

#Create labeled pie chart of percentage of general forest specimens with papillae on long cells of stomatal regions on abaxial surface
ggplot(guadualeaf_general_forest_per_ab_pap_sto, aes(x = "", y = perc, fill = ab_simple_papillae_long_cells_stomatal)) +
...
of stomatal region")) +
  ggtitle("Forest and Riparian") +
  scale_fill_manual(labels = c("absent", "present"), values = c("#71caeb", "#f7b54a")) +
  theme_void()


forest_pie_abaxial_simple_papillae_stomatal <- ggplot(guadualeaf_general_forest_per_ab_pap_sto, aes(x = "", y = perc, fill = ab_simple_papillae_long_cells_stomatal)) +
  geom_col() +
  coord_polar(theta = "y") +
  guides(fill = guide_legend(title = "Simple papillae on long cells
...
##General forest: Pie chart of simple papillae on long cells of interstomatal regions of abaxial leaf surface presence/absence
```{r}
...
guadualeaf_general_forest_per_ab_pap_int <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_per_ab_pap)

#Create labeled pie chart of percentage of general forest specimens with branched papillae on long cells of interstomatal regions on abaxial surface
ggplot(guadualeaf_general_forest_per_ab_pap_int, aes(x = "", y = perc, fill = ab_branch_papillae_long_cells_interstomatal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_abaxial_branched_papillae_interstomatal <- ggplot(guadualeaf_general_forest_per_ab_pap_int, aes(x = "", y = perc, fill = ab_branch_papillae_long_cells_interstomatal)) +
  geom_col() +
  coord_polar(theta = "y") +
...
##General forest: Pie chart of macrohairs on abaxial leaf surface presence/absence
```{r}
#Group by macrohairs on abaxial surface only and obtain percentage present/absent
guadualeaf_general_forest_per_ab_macro <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_per_ab_macro)

#Create labeled pie chart of percentage of general forest specimens with papillae on long cells of interstomatal zones on abaxial surface
ggplot(guadualeaf_general_forest_per_ab_macro, aes(x = "", y = perc, fill = ab_macro)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_abaxial_macrohair <- ggplot(guadualeaf_general_forest_per_ab_macro, aes(x = "", y = perc, fill = ab_macro)) +
  geom_col() +
  coord_polar(theta = "y") +
...
##General forest: Pie chart of smooth saddle-shaped silica bodies in intercostal zones on abaxial leaf surface presence/absence
```{r}
...
guadualeaf_general_forest_smooth_saddle_int_ab <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_smooth_saddle_int_ab)

#Create labeled pie chart of percentage of general forest specimens with smooth saddle-shaped silica bodies on long cells of intercostal zones on abaxial surface
ggplot(guadualeaf_general_forest_smooth_saddle_int_ab, aes(x = "", y = perc, fill = ab_smooth_saddle_intercostal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_abaxial_smooth_saddle_int <- ggplot(guadualeaf_general_forest_smooth_saddle_int_ab, aes(x = "", y = perc, fill = ab_smooth_saddle_intercostal)) +
  geom_col() +
  coord_polar(theta = "y") +
...
##General forest: Pie chart of nodular silica bodies in intercostal zones on abaxial leaf surface presence/absence
```{r}
#Group by nodular silica bodes in intercostal zones on abaxial surface only and obtain percentage present/absent
guadualeaf_general_forest_nodular_int_ab <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_nodular_int_ab)
...
ggplot(guadualeaf_general_forest_nodular_int_ab, aes(x = "", y = perc, fill = ab_nodular_intercostal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_abaxial_nodular_int <- ggplot(guadualeaf_general_forest_nodular_int_ab, aes(x = "", y = perc, fill = ab_nodular_intercostal)) +
  geom_col() +
  coord_polar(theta = "y") +
...
##General forest: Pie chart of bilobate silica bodies in costal zones on abaxial leaf surface presence/absence
```{r}
#Group by bilobate silica bodes in intercostal zones on abaxial surface only and obtain percentage present/absent
guadualeaf_general_forest_bilobate_cost_ab <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_bilobate_cost_ab)

#Create labeled pie chart of percentage of general forest specimens with bilobate silica bodies on long cells of costal zones on abaxial surface
ggplot(guadualeaf_general_forest_bilobate_cost_ab, aes(x = "", y = perc, fill = ab_bilobate_costal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_abaxial_bilobate_cost <- ggplot(guadualeaf_general_forest_bilobate_cost_ab, aes(x = "", y = perc, fill = ab_bilobate_costal)) +
  geom_col() +
  coord_polar(theta = "y") +
...
##General forest: Pie chart of ridged saddle-shaped silica bodies in costal zones on abaxial leaf surface presence/absence
```{r}
...
guadualeaf_general_forest_ridged_saddle_cost_ab <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_ridged_saddle_cost_ab)

#Create labeled pie chart of percentage of general forest specimens with ridged saddle-shaped silica bodies on long cells of intercostal zones on abaxial surface
ggplot(guadualeaf_general_forest_ridged_saddle_cost_ab, aes(x = "", y = perc, fill = ab_ridged_saddle_costal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_abaxial_ridged_saddle_cost <- ggplot(guadualeaf_general_forest_ridged_saddle_cost_ab, aes(x = "", y = perc, fill = ab_ridged_saddle_costal)) +
  geom_col() +
  coord_polar(theta = "y") +
...
```
##General forest: Pie chart of simple papillae on long cells in stomatal region on adaxial leaf surface presence/absence
```{r}
#Group by simple papillae on long cells in stomatal region on adaxial surface only and obtain percentage present/absent
guadualeaf_general_forest_simple_pap_stom_ad <- guadualeaf_general_forest %>% 
...
#Create labeled pie chart of percentage of general forest specimens with simple papillae on long cells in stomatal region on abaxial surface
ggplot(guadualeaf_general_forest_simple_pap_stom_ad, aes(x = "", y = perc, fill = ad_simple_papillae_long_cells_stomatal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_adaxial_papillae_simple_stomatal <- ggplot(guadualeaf_general_forest_simple_pap_stom_ad, aes(x = "", y = perc, fill = ad_simple_papillae_long_cells_stomatal)) +
  geom_col() +
  coord_polar(theta = "y") +
...
```
##General forest: Pie chart of bicellular microhairs on adaxial leaf surface presence/absence
```{r}
#Group by bicellular microhairs on adaxial surface only and obtain percentage present/absent
guadualeaf_general_forest_per_ad_bimicro <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_per_ad_bimicro)

#Create labeled pie chart of percentage of general forest specimens with macrohairs on adaxial surface
ggplot(guadualeaf_general_forest_per_ad_bimicro, aes(x = "", y = perc, fill = ad_bimicro)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_adaxial_bimicro <- ggplot(guadualeaf_general_forest_per_ad_bimicro, aes(x = "", y = perc, fill = ad_bimicro)) +
  geom_col() +
  coord_polar(theta = "y") +
...
##General forest: Pie chart of macrohairs on adaxial leaf surface presence/absence
```{r}
#Group by macrohairs on adaxial surface only and obtain percentage present/absent
guadualeaf_general_forest_per_ad_macro <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_per_ad_macro)

#Create labeled pie chart of percentage of general forest specimens with macrohairs on adaxial surface
ggplot(guadualeaf_general_forest_per_ad_macro, aes(x = "", y = perc, fill = ad_macro)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_adaxial_macro <- ggplot(guadualeaf_general_forest_per_ad_macro, aes(x = "", y = perc, fill = ad_macro)) +
  geom_col() +
  coord_polar(theta = "y") +
...
##General forest: Pie chart of smooth saddle-shaped silica bodies in intercostal zones on adaxial leaf surface presence/absence
```{r}
...
guadualeaf_general_forest_smooth_saddle_int_ad <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_smooth_saddle_int_ad)

#Create labeled pie chart of percentage of general forest specimens with smooth saddle-shaped silica bodies on long cells of intercostal zones on adaxial surface
ggplot(guadualeaf_general_forest_smooth_saddle_int_ad, aes(x = "", y = perc, fill = ad_smooth_saddle_intercostal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_adaxial_smooth_saddle_int <- ggplot(guadualeaf_general_forest_smooth_saddle_int_ad, aes(x = "", y = perc, fill = ad_smooth_saddle_intercostal)) +
  geom_col() +
  coord_polar(theta = "y") +
  guides(fill = guide_legend(title = "Smooth saddle-shaped silica bodies in 
...
```
##General forest: Pie chart of nodular silica bodies in intercostal zones on adaxial leaf surface presence/absence
```{r}
#Group by nodular silica bodes in intercostal zones on adaxial surface only and obtain percentage present/absent
guadualeaf_general_forest_nodular_int_ad <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_nodular_int_ad)

#Create labeled pie chart of percentage of general forest specimens with nodular silica bodies on long cells of intercostal zones on adaxial surface
ggplot(guadualeaf_general_forest_nodular_int_ad, aes(x = "", y = perc, fill = ad_nodular_intercostal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_adaxial_nodular_int <- ggplot(guadualeaf_general_forest_nodular_int_ad, aes(x = "", y = perc, fill = ad_nodular_intercostal)) +
  geom_col() +
  coord_polar(theta = "y") +
  guides(fill = guide_legend(title = "Nodular silica bodies in 
  intercostal zone on adaxial surface")) +
...
##General forest: Pie chart of bilobate silica bodies in costal zones on adaxial leaf surface presence/absence
```{r}
#Group by bilobate silica bodes in intercostal zones on adaxial surface only and obtain percentage present/absent
guadualeaf_general_forest_bilobate_cost_ad <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_bilobate_cost_ad)

#Create labeled pie chart of percentage of general forest specimens with bilobate silica bodies on long cells of costal zones on abaxial surface
ggplot(guadualeaf_general_forest_bilobate_cost_ad, aes(x = "", y = perc, fill = ad_bilobate_costal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_adaxial_bilobate_cost <- ggplot(guadualeaf_general_forest_bilobate_cost_ad, aes(x = "", y = perc, fill = ad_bilobate_costal)) +
  geom_col() +
  coord_polar(theta = "y") +
  guides(fill = guide_legend(title = "Bilobate silica bodies in 
...
```
##General forest: Pie chart of ridged saddle-shaped silica bodies in costal zones on adaxial leaf surface presence/absence
```{r}
...
guadualeaf_general_forest_ridged_saddle_cost_ad <- guadualeaf_general_forest %>% 
...
#view(guadualeaf_general_forest_ridged_saddle_cost_ad)

#Create labeled pie chart of percentage of general forest specimens with ridged saddle-shaped silica bodies on long cells of costal zones on adaxial surface
ggplot(guadualeaf_general_forest_ridged_saddle_cost_ad, aes(x = "", y = perc, fill = ad_ridged_saddle_costal)) +
  geom_col(color = "black") +
  geom_label(aes(label = labels),
             position = position_stack(vjust = 0.5),
             show.legend = FALSE) +
...
forest_pie_adaxial_ridged_saddle_cost <- ggplot(guadualeaf_general_forest_ridged_saddle_cost_ad, aes(x = "", y = perc, fill = ad_ridged_saddle_costal)) +
  geom_col() +
  coord_polar(theta = "y") +
  guides(fill = guide_legend(title = "Ridged saddle-shaped silica bodies in 
  costal zone on adaxial surface")) +
...
#Create labeled pie chart of percentage of general forest specimens with ridged saddle-shaped silica bodies on long cells of costal zones on abaxial surface
