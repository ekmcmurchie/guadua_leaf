...
From this we can obtain eigenvalues and then plot them to show the percent variation explained along each PCoA axis. As seen in the plot below, PCoA axes 1 and 2 are responsible for less than half of variation in the PCoA. Elbow is at approximately the seventh principal coordinate axis. Variation becomes negligible at approximately the 30th principal coordinate axis.
```{r}
