...
```{r}
guadua_floret_y_binary <- df_guaduafloret[,11:ncol(df_guaduafloret)] # reads in the binary data only 
...
corrs <- ggcorrplot(correlation_y_guadua_floret, hc.order = TRUE, lab = TRUE)

ggsave("floretcorrplot.pdf", plot = corrs, width = 16, height = 14, units = "in", dpi = 300)

corrs2 <- ggcorrplot(correlation_y_guadua_floret, hc.order = TRUE, lab = TRUE, type = "upper")

ggsave("floretcorrplot2.pdf", plot = corrs2, width = 16, height = 14, units = "in", dpi = 300)
```
...
ggsave("florethabits3.pdf", plot = habitatpcoa, width = 6, height = 4, units = "in", dpi = 300)
```
...
ggsave("florethabits2.pdf", plot = habits2pcoa, width = 6, height = 4, units = "in", dpi = 300)
...
ggsave("florethabitat3.pdf", plot = habitatspcoa, width = 6, height = 4, units = "in", dpi = 300)
...
ggsave("florethabitat2.pdf", plot = habitats2pcoa, width = 6, height = 4, units = "in", dpi = 300)
```
...
ggsave("floretregion.pdf", plot = regionpcoa, width = 6, height = 4, units = "in", dpi = 300)
```
...
ggsave("floretscree.pdf", plot = scree, width = 6, height = 4, units = "in", dpi = 300)
```
